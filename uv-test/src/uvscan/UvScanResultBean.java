...
/**
 * Result bean for UV-SCAN
 * Stores the project details
 * count of urls in different UrlPassLevel
 * List of urls in different UrlPassLevel
 * result of UV-SCAN for a specific locale
 * @author aaggarwa
 *
 */
public class UvScanResultBean {
	...
	{
		/*String resultBeanInString = ";Locale:"+this.getLocale()+";totalCount:"+this.getTotalCount()+";passedCount:"+this.getPassedCount()+";passedWithExceptionCount:"
									+this.getPassedWithExceptionCount()+";failedCount:"+this.getFailedCount()+";newUrlCount:"+this.getNewUrlCount()+";deletedUrlCount:"+this.getDeletedUrlCount()+";lastUpdated:"+this.getLastUpdated();*/
		String resultBeanInString = ";Locale:"+this.getLocale()+";totalCount:"+this.getTotalCount()+";passedCount:"+this.getPassedCount()+";passedWithExceptionCount:"
				+this.getPassedWithExceptionCount()+";failedCount:"+this.getFailedCount()+";lastUpdated:"+this.getLastUpdated();

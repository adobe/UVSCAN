...
/**
 * Constructor used for instantiation for urls found in strings retrived form ALF
 * @param stringID
 * @param baseUrl
 */
 ...
 */
	public UvScanUrl(String stringID , String configUrlPattern , String configRedirectedUrlPattern , String configEngUrl , String configEngRedirectedUrl , String patternRemarks , String userRemarks )
	{
		this.stringID = stringID;
 ...
 */
	...
	public void setRedirectedUrlPatternMatchResult(
			String redirectedUrlPatternMatchResult) {
	...
	public void setFollowsConfigRedirectedUrlPattern(
			Boolean followsConfigRedirectedUrlPattern) {
	...
	public void setFollowsExactConfigRedirectedUrlPattern(
			Boolean followsExactConfigRedirectedUrlPattern) {
 ...
 */
	public String isErrorPage()
	{
		...
		return  (this.isErrorPage?Configuration.getConstant("Display_Message_For_ErrorPage"):Configuration.getConstant("Display_Message_For_Not_ErrorPage"));
	}

/**
 * 
 * @return String to be displayed for according to url status(New/Existing/Deleted)
 */
